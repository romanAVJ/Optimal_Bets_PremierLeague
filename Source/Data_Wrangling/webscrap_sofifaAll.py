# -*- coding: utf-8 -*-
"""
Created on Mon Mar 01 09:11:54 2021
...
# =============================================================================
# INIT
DUMMY_URL = """https://sofifa.com/teams?type=all&lg%5B0%5D=13&showCol%5B0%5D=
ti&showCol%5B1%5D=oa&showCol%5B2%5D=at&showCol%5B3%5D=md&showCol%5B4%5D=
df&showCol%5B5%5D=tb&showCol%5B6%5D=bs&showCol%5B7%5D=bd&showCol%5B8%5D=
bp&showCol%5B9%5D=bps&showCol%5B10%5D=cc&showCol%5B11%5D=cp&showCol%5B12%5D=
cs&showCol%5B13%5D=cps&showCol%5B14%5D=da&showCol%5B15%5D=dm&showCol%5B16%5D=
dw&showCol%5B17%5D=dd&showCol%5B18%5D=dp&showCol%5B19%5D=ip&showCol%5B20%5D=
ps&showCol%5B21%5D=sa&showCol%5B22%5D=ta&r=140001&set=true"""

PRODUCT_FOLDER = "Data/SoFIFA/"
PRODUCT_FILE_CSV = PRODUCT_FOLDER + "FIFAs14_21.csv"
PRODUCT_FILE_FEA = PRODUCT_FOLDER + "FIFAs14_21.feather"

# get data from url
dummy_soup = get_html(DUMMY_URL, parser='html.parser')

# %% fetching data

# get all fifa's url after 2014
urls_fifa_raw = get_fifa_urls(dummy_soup)
...
# %% tidy 
# tidy data
list_dataframes = map(tidy_dataframe, lists_dataframes_raw)
df_main = joindata(list_dataframes)

# write to csv/feather
Path(PRODUCT_FOLDER).mkdir(parents=True, exist_ok=True)

df_main.to_csv(PRODUCT_FILE_CSV, index=False)
df_main.to_feather(PRODUCT_FILE_FEA)
